...
export default function Chat() {
  ...
  return (
    <div 
      className={`h-screen flex flex-col bg-cover bg-center bg-no-repeat text-white relative overflow-hidden ${view === "chat" ? "" : "bg-gradient-to-br from-slate-950 via-zinc-900 to-neutral-950"}`}
      style={{ backgroundImage: view === "chat" ? `url(${import.meta.env.BASE_URL}background-black.jpg)` : "none" }}
    >
      {view === "chat" && <div className="absolute inset-0 bg-black/30 backdrop-blur-[1px] pointer-events-none" />}
      {error && (
